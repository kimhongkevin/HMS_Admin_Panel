...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="mb-6">
            <h2 class="font-semibold text-3xl text-gray-800 leading-tight">Book New Appointment</h2>
            <p class="text-gray-600 mt-1">Schedule an appointment for a patient</p>
        </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <form method="POST" action="{{ route('appointments.store') }}" id="appointmentForm">
                ...
                <div class="mb-6" id="timeSlotsContainer" style="display: none;">
                    ...
                    <div id="timeSlotsLoading" class="text-center py-4 text-gray-500">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes" id="notes" rows="4" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Additional notes or special requirements...">{{ old('notes') }}</textarea>
                    @error('notes')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
