            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form action="{{ route('documents.update', $document) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="patient_id" id="patient_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            @foreach($patients as $patient)
                                <option value="{{ $patient->id }}" {{ old('patient_id', $document->patient_id) == $patient->id ? 'selected' : '' }}>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="document_type" id="document_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <option value="medical_record" {{ old('document_type', $document->document_type) == 'medical_record' ? 'selected' : '' }}>Medical Record</option>
                                <option value="lab_report" {{ old('document_type', $document->document_type) == 'lab_report' ? 'selected' : '' }}>Lab Report</option>
                        ...
                        <div>
                            ...
                            <input type="date" name="document_date" id="document_date" value="{{ old('document_date', $document->document_date->format('Y-m-d')) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $document->title) }}" placeholder="e.g. Blood Test Results" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="mt-2 p-4 bg-gray-50 rounded-md">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-gray-500">{{ $document->file_size_formatted }} • {{ strtoupper(pathinfo($document->file_name, PATHINFO_EXTENSION)) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mb-2">Leave empty to keep the current file</p>
                    ...
                    <div class="flex items-center justify-between pt-6">
                        <a href="{{ route('documents.show', $document) }}" class="text-gray-600 hover:text-gray-800">Cancel</a>
